      ...
      <div className="quick-start-steps">
        <div className="quick-start-step">
          ...
          <div className="step-content">
            ...
            <p>One command installs sparkrun, sets up a managed environment, and configures tab completion.</p>
            <pre className="sl-code"><code>uvx sparkrun setup install</code></pre>
          </div>
        </div>
        <div className="quick-start-step">
          ...
          <div className="step-content">
            ...
            <p>Save your DGX Spark hosts once. sparkrun remembers them for every launch.</p>
        ...
        <div className="quick-start-step">
          ...
          <div className="step-content">
            ...
            <pre className="sl-code"><code>sparkrun run qwen3-1.7b-vllm --tp 2</code></pre>
          </div>
        </div>
      </div>
    </div>
